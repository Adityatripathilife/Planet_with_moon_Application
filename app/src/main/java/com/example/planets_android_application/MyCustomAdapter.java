...
public class MyCustomAdapter extends ArrayAdapter<Planet> {
    ...
    // View Holder Class - used to cache references to the view within an itm layout ,
    // so they don't need to be repeatedly locked up during scrolling
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            // Finding the Views: we need find view my id
        ...
        // Getting the data from modal class
